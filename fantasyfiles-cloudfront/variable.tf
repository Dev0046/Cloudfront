...
variable "oac_origin_type" {
  description = "The type of origin this OAC will control (e.g., 's3')"
  type        = string
}

variable "oac_signing_behavior" {
  description = "The signing behavior for the OAC (e.g., 'always')"
  type        = string
}

variable "oac_signing_protocol" {
  description = "The signing protocol for the OAC (e.g., 'sigv4')"
  type        = string
}
...
##
variable "s3_origin_config" {
  description = "List of S3 origin configurations"
  type = list(object({
    domain_name                          = string
    origin_id                            = string
    origin_access_control_attachment     = optional(bool, false) # Default to false
    origin_access_identity_attachment    = optional(bool, false) # Default to false
