...
dynamic "origin" {
  ...
  content {
    ...
    # Conditionally set origin_access_control_id
    origin_access_control_id = origin.value.origin_access_control_attachment ? aws_cloudfront_origin_access_control.oac.id : null
    ...
    dynamic "s3_origin_config" {
      ...
      content {
        origin_access_identity = origin.value.origin_access_identity_attachment ? aws_cloudfront_origin_access_identity.this.cloudfront_access_identity_path : ""
      }
    }
  }
}
